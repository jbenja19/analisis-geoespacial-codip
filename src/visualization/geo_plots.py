...
def plot_clusters_static(gdf: gpd.GeoDataFrame, cluster_col: str = "cluster",
                          title: str = "Segmentacion Geoespacial de Proyectos") -> plt.Figure:
    ...
    gdf.plot(column=cluster_col, ax=ax, cmap=cmap, legend=True,
